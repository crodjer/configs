((ac-cider status "installed" recipe
 ...
 (async status "installed" recipe
        (:name async :auto-generated t :type elpa :description "Asynchronous processing in Emacs" :repo nil))
 ...
 (flx-ido status "installed" recipe
          (:name flx-ido :auto-generated t :type elpa :description "flx integration for ido" :repo nil :depends
                 (flx cl-lib)))
