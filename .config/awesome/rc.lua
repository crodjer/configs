...
globalkeys = awful.util.table.join(
    ...
    -- Monitor controls
    awful.key({ modkey, "Control", "Shift"}, "1", function () awful.util.spawn_with_shell("~/.screenlayout/external.sh") end),
    awful.key({ modkey, "Control", "Shift"}, "2", function () awful.util.spawn_with_shell("~/.screenlayout/lr.sh") end),
